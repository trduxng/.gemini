...
<ThinkingProcess>
  ...
  <ActionPlan>
    1. [Bước 1: Tìm kiếm nhanh bằng grep]
    2. [Bước 2: Sửa đổi file X dòng Y]
    3. [Bước 3: Chạy lệnh test Z]
  </ActionPlan>
</ThinkingProcess>
```
...
- **On-Demand Loading:** Tùy thuộc vào ngữ cảnh dự án (dựa trên branch, loại file đang mở, hoặc yêu cầu của người dùng), hãy sử dụng lệnh `activate_skill` để nạp MỘT HOẶC NHIỀU nhóm thư mục cụ thể (nhưng giữ ở mức tối thiểu):
